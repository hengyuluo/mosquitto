...
//	printf("9999999999999999999999%s\n",combination);	
	...
	strncat(combination, "clientid", 9);
	strncat(combination, ID, strlen(ID));
	strncat(combination, "deviceName", 11);
	strncat(combination, deviceName, strlen(deviceName));
	strncat(combination, "productKey", 11);
	strncat(combination, productKey, strlen(productKey));
	strncat(combination, "timestamp", 10);
	strncat(combination, realTimeStamp, strlen(realTimeStamp));
	printf("combine:");
