...
//	printf("9999999999999999999999%s\n",combination);	
	...
	strcat(combination, "clientid", 9);
	strcat(combination, ID, strlen(ID));
	strcat(combination, "deviceName", 11);
	strcat(combination, deviceName, strlen(deviceName));
	strcat(combination, "productKey", 11);
	strcat(combination, productKey, strlen(productKey));
	strcat(combination, "timestamp", 10);
	strcat(combination, realTimeStamp, strlen(realTimeStamp));
	printf("combine:");
